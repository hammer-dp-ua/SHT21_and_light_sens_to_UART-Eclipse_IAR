...
/*!< USART CR1 register clear Mask ((~(unsigned int)0xFFFFE6F3)) */
#define CR1_CLEAR_MASK            ((unsigned int)(USART_CR1_M | USART_CR1_PCE | \
                                              USART_CR1_PS | USART_CR1_TE | \
                                              USART_CR1_RE))

/*!< USART CR2 register clock bits clear Mask ((~(unsigned int)0xFFFFF0FF)) */
#define CR2_CLOCK_CLEAR_MASK      ((unsigned int)(USART_CR2_CLKEN | USART_CR2_CPOL | \
                                              USART_CR2_CPHA | USART_CR2_LBCL))

/*!< USART CR3 register clear Mask ((~(unsigned int)0xFFFFFCFF)) */
#define CR3_CLEAR_MASK            ((unsigned int)(USART_CR3_RTSE | USART_CR3_CTSE))

/*!< USART Interrupts mask */
#define IT_MASK                   ((unsigned int)0x000000FF)
...
{
  unsigned int divider = 0, apbclock = 0, tmpreg = 0;
  ...
  /* Disable USART */
  USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_UE);
  
  /*---------------------------- USART CR2 Configuration -----------------------*/
  tmpreg = USARTx->CR2;
  /* Clear STOP[13:12] bits */
  tmpreg &= (unsigned int)~((unsigned int)USART_CR2_STOP);
  ...
  tmpreg &= (unsigned int)~((unsigned int)CR1_CLEAR_MASK);
  
  /* Configure the USART Word Length, Parity and mode ----------------------- */
  /* Set the M bits according to USART_WordLength value */
  /* Set PCE and PS bits according to USART_Parity value */
  /* Set TE and RE bits according to USART_Mode value */
  tmpreg |= (unsigned int)USART_InitStruct->USART_WordLength | USART_InitStruct->USART_Parity |
  ...
  tmpreg &= (unsigned int)~((unsigned int)CR3_CLEAR_MASK);
  ...
  if ((USARTx->CR1 & USART_CR1_OVER8) != 0)
  {
    ...
    divider = (unsigned int)((2 * apbclock) / (USART_InitStruct->USART_BaudRate));
    tmpreg  = (unsigned int)((2 * apbclock) % (USART_InitStruct->USART_BaudRate));
  }
  else /* if ((USARTx->CR1 & CR1_OVER8_Set) == 0) */
  {
    /* (divider * 10) computing in case Oversampling mode is 16 Samples */
    divider = (unsigned int)((apbclock) / (USART_InitStruct->USART_BaudRate));
    tmpreg  = (unsigned int)((apbclock) % (USART_InitStruct->USART_BaudRate));
  }
  ...
  if ((USARTx->CR1 & USART_CR1_OVER8) != 0)
  {
    ...
    tmpreg = (divider & (unsigned short)0x000F) >> 1;
    
    /* update the divider value */
    divider = (divider & (unsigned short)0xFFF0) | tmpreg;
  }
  
  /* Write to USART BRR */
  USARTx->BRR = (unsigned short)divider;
}
...
//---------------------------- USART CR2 Configuration -----------------------
  ...
  tmpreg &= (unsigned int)~((unsigned int)CR2_CLOCK_CLEAR_MASK);
  // Configure the USART Clock, CPOL, CPHA, LastBit and SSM ------------
  // Set CLKEN bit according to USART_Clock value 
  // Set CPOL bit according to USART_CPOL value 
  // Set CPHA bit according to USART_CPHA value 
  // Set LBCL bit according to USART_LastBit value 
  tmpreg |= (unsigned int)(USART_ClockInitStruct->USART_Clock | USART_ClockInitStruct->USART_CPOL |
...
/**
  ...
  * @retval None
  */
/*void USART_DirectionModeCmd(USART_TypeDef* USARTx, unsigned int USART_DirectionMode, FunctionalState NewState)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  else
  {
    ...
    USARTx->CR1 &= (unsigned int)~USART_DirectionMode;
  }
}*/
...
void USART_OverSampling8Cmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_OVER8);
  }
}  
...
/*void USART_OneBitMethodCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_ONEBIT);
  }
}*/
...
/*void USART_MSBFirstCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_MSBFIRST);
  }
}*/
...
/*void USART_DataInvCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    // the CR2 register
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_DATAINV);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_InvPinCmd(USART_TypeDef* USARTx, unsigned int USART_InvPin, FunctionalState NewState)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~USART_InvPin;
  }
}*/
...
/*void USART_SWAPPinCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_SWAP);
  }
}*/
...
/*void USART_ReceiverTimeOutCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_RTOEN);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_SetReceiverTimeOut(USART_TypeDef* USARTx, unsigned int USART_ReceiverTimeOut)
{    
  // Check the parameters 
  assert_param(IS_USART_123_PERIPH(USARTx));
  ...
  USARTx->RTOR &= (unsigned int)~((unsigned int)USART_RTOR_RTO);
...
/*void USART_STOPModeCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_UESM);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_StopModeWakeUpSourceConfig(USART_TypeDef* USARTx, unsigned int USART_WakeUpSource)
{
  // Check the parameters 
  assert_param(IS_USART_123_PERIPH(USARTx));
  assert_param(IS_USART_STOPMODE_WAKEUPSOURCE(USART_WakeUpSource));

  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_WUS);
...
/*void USART_AutoBaudRateCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_ABREN);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_AutoBaudRateConfig(USART_TypeDef* USARTx, unsigned int USART_AutoBaudRate)
{
  // Check the parameters 
  assert_param(IS_USART_123_PERIPH(USARTx));
  assert_param(IS_USART_AUTOBAUDRATE_MODE(USART_AutoBaudRate));

  USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_ABRMODE);
...
/*void USART_SendData(USART_TypeDef* USARTx, unsigned short Data)
{
  ...
  // Transmit Data 
  USARTx->TDR = (Data & (unsigned short)0x01FF);
}*/
...
unsigned short USART_ReceiveData(USART_TypeDef* USARTx)
{
  ...
  /* Receive Data */
  return (unsigned short)(USARTx->RDR & (unsigned short)0x01FF);
}
...
/*void USART_SetAddress(USART_TypeDef* USARTx, uint8_t USART_Address)
{
  ...
  USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_ADD);
  // Set the USART address node 
  USARTx->CR2 |=((unsigned int)USART_Address << (unsigned int)0x18);
}*/
...
/*void USART_MuteModeCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_MME);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_MuteModeWakeUpConfig(USART_TypeDef* USARTx, unsigned int USART_WakeUp)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  assert_param(IS_USART_MUTEMODE_WAKEUP(USART_WakeUp));

  USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_WAKE);
...
/**
  ...
  * @retval None
  */
/*void USART_AddressDetectionConfig(USART_TypeDef* USARTx, unsigned int USART_AddressLength)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  assert_param(IS_USART_ADDRESS_DETECTION(USART_AddressLength));

  USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_ADDM7);
...
/**
  ...
  * @retval None
  */
/*void USART_LINBreakDetectLengthConfig(USART_TypeDef* USARTx, unsigned int USART_LINBreakDetectLength)
{
  // Check the parameters 
  assert_param(IS_USART_123_PERIPH(USARTx));
  assert_param(IS_USART_LIN_BREAK_DETECT_LENGTH(USART_LINBreakDetectLength));

  USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_LBDL);
...
/*void USART_LINCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (unsigned int)~((unsigned int)USART_CR2_LINEN);
  }
}*/
...
/*void USART_HalfDuplexCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_HDSEL);
  }
}*/
...
{    
  ...
  USARTx->GTPR |= (unsigned short)((unsigned short)USART_GuardTime << 0x08);
}*/
...
/*void USART_SmartCardCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_SCEN);
  }
}*/
...
/*void USART_SmartCardNACKCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_NACK);
  }
}*/
...
{    
  ...
  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_SCARCNT);
  // Set the USART auto retry count
  USARTx->CR3 |= (unsigned int)((unsigned int)USART_AutoCount << 0x11);
}*/
...
{    
  ...
  USARTx->RTOR &= (unsigned int)~((unsigned int)USART_RTOR_BLEN);
  // Set the Smart Card block length 
  USARTx->RTOR |= (unsigned int)((unsigned int)USART_BlockLength << 0x18);
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_IrDAConfig(USART_TypeDef* USARTx, unsigned int USART_IrDAMode)
{
  // Check the parameters 
  assert_param(IS_USART_123_PERIPH(USARTx));
  assert_param(IS_USART_IRDA_MODE(USART_IrDAMode));

  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_IRLP);
...
/*void USART_IrDACmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_IREN);
  }
}*/
/**
  * @}
...
/*void USART_DECmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_DEM);
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_DEPolarityConfig(USART_TypeDef* USARTx, unsigned int USART_DEPolarity)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  assert_param(IS_USART_DE_POLARITY(USART_DEPolarity));

  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_DEP);
...
/**
  ...
  * @retval None
  */
/*void USART_SetDEAssertionTime(USART_TypeDef* USARTx, unsigned int USART_DEAssertionTime)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_DEAT);
  // Set the new value for the DE assertion time 
  USARTx->CR1 |=((unsigned int)USART_DEAssertionTime << (unsigned int)0x15);
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_SetDEDeassertionTime(USART_TypeDef* USARTx, unsigned int USART_DEDeassertionTime)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  USARTx->CR1 &= (unsigned int)~((unsigned int)USART_CR1_DEDT);
  // Set the new value for the DE deassertion time 
  USARTx->CR1 |=((unsigned int)USART_DEDeassertionTime << (unsigned int)0x10);
}*/
...
@verbatim   
 ...
 ===============================================================================
    ...
    [..] In this Mode it is advised to use the following function:
         (+) void USART_DMACmd(USART_TypeDef* USARTx, unsigned short USART_DMAReq,
...
/**
  ...
  * @retval None
  */
void USART_DMACmd(USART_TypeDef* USARTx, unsigned int USART_DMAReq, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT and/or
       DMAR bits in the USART CR3 register */
    USARTx->CR3 &= (unsigned int)~USART_DMAReq;
  }
}
...
/**
  ...
  * @retval None
  */
/*void USART_DMAReceptionErrorConfig(USART_TypeDef* USARTx, unsigned int USART_DMAOnError)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_DDRE);
 ...
 *** Polling Mode ***
 ====================
    ...
    [..] In this Mode it is advised to use the following functions:
         (+) FlagStatus USART_GetFlagStatus(USART_TypeDef* USARTx, unsigned short USART_FLAG).
         (+) void USART_ClearFlag(USART_TypeDef* USARTx, unsigned short USART_FLAG).
 ...
 *** Interrupt Mode ***
 ======================
    ...
    [..] In this Mode it is advised to use the following functions:
         (+) void USART_ITConfig(USART_TypeDef* USARTx, unsigned short USART_IT, FunctionalState NewState).
         (+) ITStatus USART_GetITStatus(USART_TypeDef* USARTx, unsigned short USART_IT).
...
/**
  ...
  * @retval None
  */
void USART_ITConfig(USART_TypeDef* USARTx, unsigned int USART_IT, FunctionalState NewState)
{
  unsigned int usartreg = 0, itpos = 0, itmask = 0;
  ...
  usartreg = (((unsigned short)USART_IT) >> 0x08);
  ...
  if (NewState != DISABLE)
  {
    *(__IO unsigned int*)usartxbase  |= itmask;
  }
  else
  {
    *(__IO unsigned int*)usartxbase &= ~itmask;
...
/**
  ...
  * @retval None
  */
/*void USART_RequestCmd(USART_TypeDef* USARTx, unsigned int USART_Request, FunctionalState NewState)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  else
  {
    ...
    USARTx->RQR &= (unsigned int)~USART_Request;
  }
}*/
...
/**
  ...
  * @retval None
  */
/*void USART_OverrunDetectionConfig(USART_TypeDef* USARTx, unsigned int USART_OVRDetection)
{
  // Check the parameters 
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  ...
  USARTx->CR3 &= (unsigned int)~((unsigned int)USART_CR3_OVRDIS);
...
/**
  ...
  */
FlagStatus USART_GetFlagStatus(USART_TypeDef* USARTx, unsigned int USART_FLAG)
{
  ...
  if ((USARTx->ISR & USART_FLAG) != (unsigned short)RESET)
  {
    bitstatus = SET;
  }
  else
...
/**
  ...
  * @retval None
  */
void USART_ClearFlag(USART_TypeDef* USARTx, unsigned int USART_FLAG)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(USARTx));
...
/**
  ...
  */
/*ITStatus USART_GetITStatus(USART_TypeDef* USARTx, unsigned int USART_IT)
{
  unsigned int bitpos = 0, itmask = 0, usartreg = 0;
...
/**
  ...
  * @retval None
  */
void USART_ClearITPendingBit(USART_TypeDef* USARTx, unsigned int USART_IT)
{
  unsigned int bitpos = 0, itmask = 0;
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(USARTx));
  assert_param(IS_USART_CLEAR_IT(USART_IT)); 
  
  bitpos = USART_IT >> 0x10;
  itmask = ((unsigned int)0x01 << (unsigned int)bitpos);
  USARTx->ICR = (unsigned int)itmask;
}
