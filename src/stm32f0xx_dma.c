...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define CCR_CLEAR_MASK   ((unsigned int)0xFFFF800F) /* DMA Channel config registers Masks */
#define FLAG_Mask        ((unsigned int)0x10000000) /* DMA2 FLAG mask */

/* DMA1 Channelx interrupt pending bit masks */
#define DMA1_CHANNEL1_IT_MASK    ((unsigned int)(DMA_ISR_GIF1 | DMA_ISR_TCIF1 | DMA_ISR_HTIF1 | DMA_ISR_TEIF1))
#define DMA1_CHANNEL2_IT_MASK    ((unsigned int)(DMA_ISR_GIF2 | DMA_ISR_TCIF2 | DMA_ISR_HTIF2 | DMA_ISR_TEIF2))
#define DMA1_CHANNEL3_IT_MASK    ((unsigned int)(DMA_ISR_GIF3 | DMA_ISR_TCIF3 | DMA_ISR_HTIF3 | DMA_ISR_TEIF3))
#define DMA1_CHANNEL4_IT_MASK    ((unsigned int)(DMA_ISR_GIF4 | DMA_ISR_TCIF4 | DMA_ISR_HTIF4 | DMA_ISR_TEIF4))
#define DMA1_CHANNEL5_IT_MASK    ((unsigned int)(DMA_ISR_GIF5 | DMA_ISR_TCIF5 | DMA_ISR_HTIF5 | DMA_ISR_TEIF5))
#define DMA1_CHANNEL6_IT_MASK    ((unsigned int)(DMA_ISR_GIF6 | DMA_ISR_TCIF6 | DMA_ISR_HTIF6 | DMA_ISR_TEIF6)) /*!< Only applicable for STM32F072 and STM32F091 devices */
#define DMA1_CHANNEL7_IT_MASK    ((unsigned int)(DMA_ISR_GIF7 | DMA_ISR_TCIF7 | DMA_ISR_HTIF7 | DMA_ISR_TEIF7)) /*!< Only applicable for STM32F072 and STM32F091 devices */
    
/* DMA2 Channelx interrupt pending bit masks: Only applicable for STM32F091 devices */
#define DMA2_CHANNEL1_IT_MASK    ((unsigned int)(DMA_ISR_GIF1 | DMA_ISR_TCIF1 | DMA_ISR_HTIF1 | DMA_ISR_TEIF1))
#define DMA2_CHANNEL2_IT_MASK    ((unsigned int)(DMA_ISR_GIF2 | DMA_ISR_TCIF2 | DMA_ISR_HTIF2 | DMA_ISR_TEIF2))
#define DMA2_CHANNEL3_IT_MASK    ((unsigned int)(DMA_ISR_GIF3 | DMA_ISR_TCIF3 | DMA_ISR_HTIF3 | DMA_ISR_TEIF3))
#define DMA2_CHANNEL4_IT_MASK    ((unsigned int)(DMA_ISR_GIF4 | DMA_ISR_TCIF4 | DMA_ISR_HTIF4 | DMA_ISR_TEIF4))
#define DMA2_CHANNEL5_IT_MASK    ((unsigned int)(DMA_ISR_GIF5 | DMA_ISR_TCIF5 | DMA_ISR_HTIF5 | DMA_ISR_TEIF5))
...
void DMA_Cmd(DMA_Channel_TypeDef* DMAy_Channelx, FunctionalState NewState)
{
  ...
  {
    /* Disable the selected DMAy Channelx */
    DMAy_Channelx->CCR &= (unsigned short)(~DMA_CCR_EN);
  }
}
...
/*void DMA_RemapConfig(DMA_TypeDef* DMAy, unsigned int DMAx_CHy_RemapRequest)
{
  ...
  DMAy->RMPCR &= ~((unsigned int)0x0F << (unsigned int)((DMAx_CHy_RemapRequest >> 28) * 4));
  DMAy->RMPCR |= (unsigned int)(DMAx_CHy_RemapRequest & 0x0FFFFFFF);
}*/
...
@verbatim
  ...
  *** Polling Mode ***
  ====================
    ...
    [..]In this Mode it is advised to use the following functions:
        (+) FlagStatus DMA_GetFlagStatus(unsigned int DMA_FLAG);
        (+) void DMA_ClearFlag(unsigned int DMA_FLAG);
  ...
  *** Interrupt Mode ***
  ======================
    ...
    [..]In this Mode it is advised to use the following functions:
        (+) void DMA_ITConfig(DMA_Channel_TypeDef* DMAy_Channelx, unsigned int DMA_IT,
            FunctionalState NewState);
        (+) ITStatus DMA_GetITStatus(unsigned int DMA_IT);
        (+) void DMA_ClearITPendingBit(unsigned int DMA_IT);
...
/*FlagStatus DMA_GetFlagStatus(unsigned int DMAy_FLAG)
{
  ...
  if ((DMAy_FLAG & FLAG_Mask) != (unsigned int)RESET)
  {
  ...
  if ((tmpreg & DMAy_FLAG) != (unsigned int)RESET)
  {
    // DMAy_FLAG is set 
    bitstatus = SET;
  }
...
ITStatus DMA_GetITStatus(unsigned int DMAy_IT)
{
  ...
  if ((DMAy_IT & FLAG_Mask) != (unsigned int) RESET)
  {
    // Get DMA2 ISR register value 
    tmpreg = DMA2->ISR;
  }
  ...
  if ((tmpreg & DMAy_IT) != (unsigned int) RESET)
  {
    // DMAy_IT is set 
    bitstatus = SET;
  }
