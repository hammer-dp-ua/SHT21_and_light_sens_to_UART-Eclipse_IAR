...
void init_sht21_measurements_queue() {
   sht21_measurements_queue_g[0].address = SHT21_ADDRESS;
   sht21_measurements_queue_g[0].command = TRIGGER_T_MEASUREMENT;
   sht21_measurements_queue_g[0].status = 0;

   sht21_measurements_queue_g[1].address = SHT21_ADDRESS;
   sht21_measurements_queue_g[1].command = TRIGGER_RH_MEASUREMENT;
   sht21_measurements_queue_g[1].status = 0;
}
