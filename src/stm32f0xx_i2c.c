...
#define CR1_CLEAR_MASK          ((unsigned int)0x00CFE0FF)  /*<! I2C CR1 clear register Mask */
#define CR2_CLEAR_MASK          ((unsigned int)0x07FF7FFF)  /*<! I2C CR2 clear register Mask */
#define TIMING_CLEAR_MASK       ((unsigned int)0xF0FFFFFF)  /*<! I2C TIMING clear register Mask */
#define ERROR_IT_MASK           ((unsigned int)0x00003F00)  /*<! I2C Error interrupt register Mask */
#define TC_IT_MASK              ((unsigned int)0x000000C0)  /*<! I2C TC interrupt register Mask */
...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_PE);
  ...
  tmpreg |= (unsigned int)I2C_InitStruct->I2C_AnalogFilter | (I2C_InitStruct->I2C_DigitalFilter << 8);
  ...
  tmpreg = 0;
  /* Clear OAR1 register */
  I2Cx->OAR1 = (unsigned int)tmpreg;
  /* Clear OAR2 register */
  I2Cx->OAR2 = (unsigned int)tmpreg;
  /* Configure I2Cx: Own Address1 and acknowledged address */
  /* Set OA1MODE bit according to I2C_AcknowledgedAddress value */
  /* Set OA1 bits according to I2C_OwnAddress1 value */
  tmpreg = (unsigned int)((unsigned int)I2C_InitStruct->I2C_AcknowledgedAddress | \
                      (unsigned int)I2C_InitStruct->I2C_OwnAddress1);
  /* Write to I2Cx OAR1 */
  I2Cx->OAR1 = tmpreg;
...
void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx)
{
  ...
  *(__IO unsigned int *)(unsigned int)I2Cx;
...
void I2C_ITConfig(I2C_TypeDef* I2Cx, unsigned int I2C_IT, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_IT);
  }
}
...
void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_NOSTRETCH);
  }
  else
  {
...
void I2C_StopModeCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_WUPEN);
  }
}
...
void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->OAR2 &= (unsigned int)~((unsigned int)I2C_OAR2_OA2EN);
  }
}    
...
void I2C_OwnAddress2Config(I2C_TypeDef* I2Cx, unsigned short Address, unsigned char Mask)
{
  ...
  tmpreg &= (unsigned int)~((unsigned int)(I2C_OAR2_OA2 | I2C_OAR2_OA2MSK));

  /* Set I2Cx SADD */
  tmpreg |= (unsigned int)(((unsigned int)Address & I2C_OAR2_OA2) | \
            (((unsigned int)Mask << 8) & I2C_OAR2_OA2MSK)) ;
...
void I2C_GeneralCallCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_GCEN);
  }
} 
...
void I2C_SlaveByteControlCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_SBC);
  }
}
...
void I2C_10BitAddressingModeCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_ADD10);
  }
} 
...
void I2C_AutoEndCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_AUTOEND);
  }
} 
...
void I2C_ReloadCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_RELOAD);
  }
}
...
void I2C_NumberOfBytesConfig(I2C_TypeDef* I2Cx, unsigned char Number_Bytes)
{
  ...
  tmpreg &= (unsigned int)~((unsigned int)I2C_CR2_NBYTES);

  /* Set I2Cx Nbytes */
  tmpreg |= (unsigned int)(((unsigned int)Number_Bytes << 16 ) & I2C_CR2_NBYTES);
...
/* Check the parameters */
  ...
  if (I2C_Direction == I2C_Direction_Transmitter)
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_RD_WRN);
  }
  else
  {
...
void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_START);
  }
}  
...
void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_STOP);
  }
}  
...
void I2C_10BitAddressHeaderCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_HEAD10R);
  }
}    
...
void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_NACK);
  }
  else
  {
...
unsigned char I2C_GetAddressMatched(I2C_TypeDef* I2Cx)
{
  ...
  return (unsigned char)(((unsigned int)I2Cx->ISR & I2C_ISR_ADDCODE) >> 16) ;
}
...
unsigned short I2C_GetTransferDirection(I2C_TypeDef* I2Cx)
{
  ...
  /* Return the slave matched address in the SR1 register */
  tmpreg = (unsigned int)(I2Cx->ISR & I2C_ISR_DIR);
...
void I2C_TransferHandling(I2C_TypeDef* I2Cx, unsigned short Address, unsigned char Number_Bytes, unsigned int ReloadEndMode, unsigned int StartStopMode)
{
  ...
  tmpreg &= (unsigned int)~((unsigned int)(I2C_CR2_SADD | I2C_CR2_NBYTES | I2C_CR2_RELOAD | I2C_CR2_AUTOEND | I2C_CR2_RD_WRN | I2C_CR2_START | I2C_CR2_STOP));
  
  /* update tmpreg */
  tmpreg |= (unsigned int)(((unsigned int)Address & I2C_CR2_SADD) | (((unsigned int)Number_Bytes << 16 ) & I2C_CR2_NBYTES) | \
            (unsigned int)ReloadEndMode | (unsigned int)StartStopMode);
...
void I2C_SMBusAlertCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  {
    /* Disable SMBus alert */    
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_ALERTEN);
  }
}
...
void I2C_ClockTimeoutCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->TIMEOUTR &= (unsigned int)~((unsigned int)I2C_TIMEOUTR_TIMOUTEN);
  }
}
...
void I2C_ExtendedClockTimeoutCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  {
    /* Disable Clock Timeout */    
    I2Cx->TIMEOUTR &= (unsigned int)~((unsigned int)I2C_TIMEOUTR_TEXTEN);
  }
}
...
void I2C_IdleClockTimeoutCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  {
    /* Disable Clock Timeout */    
    I2Cx->TIMEOUTR &= (unsigned int)~((unsigned int)I2C_TIMEOUTR_TIDLE);
  }
}
...
void I2C_TimeoutAConfig(I2C_TypeDef* I2Cx, unsigned short Timeout)
{
  ...
  tmpreg &= (unsigned int)~((unsigned int)I2C_TIMEOUTR_TIMEOUTA);

  /* Set I2Cx TIMEOUTA */
  tmpreg |= (unsigned int)((unsigned int)Timeout & I2C_TIMEOUTR_TIMEOUTA) ;
...
void I2C_TimeoutBConfig(I2C_TypeDef* I2Cx, unsigned short Timeout)
{
  ...
  tmpreg &= (unsigned int)~((unsigned int)I2C_TIMEOUTR_TIMEOUTB);

  /* Set I2Cx TIMEOUTB */
  tmpreg |= (unsigned int)(((unsigned int)Timeout << 16) & I2C_TIMEOUTR_TIMEOUTB) ;
...
void I2C_CalculatePEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (unsigned int)~((unsigned int)I2C_CR1_PECEN);
  }
}
...
void I2C_PECRequestCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (unsigned int)~((unsigned int)I2C_CR2_PECBYTE);
  }
}
...
unsigned char I2C_GetPEC(I2C_TypeDef* I2Cx)
{
  ...
  /* Return the slave matched address in the SR1 register */
  return (unsigned char)((unsigned int)I2Cx->PECR & I2C_PECR_PEC);
}
...
{
  __IO unsigned int tmp = 0;

  /* Check the parameters */
  assert_param(IS_I2C_ALL_PERIPH(I2Cx));
  assert_param(IS_I2C_REGISTER(I2C_Register));

  tmp = (unsigned int)I2Cx;
  tmp += I2C_Register;

  /* Return the selected register value */
  return (*(__IO unsigned int *) tmp);
}
...
unsigned char I2C_ReceiveData(I2C_TypeDef* I2Cx)
{
  ...
  return (unsigned char)I2Cx->RXDR;
}  
...
@verbatim
 ...
 ===============================================================================  
    ...
    [..] In this Mode it is advised to use the following function:
         (+) I2C_DMACmd(I2C_TypeDef* I2Cx, unsigned int I2C_DMAReq, FunctionalState NewState);
@endverbatim
  * @{
  */  
...
ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, unsigned int I2C_IT)
{
  ...
  /* If Error interrupt */
  if ((unsigned int)(I2C_IT & ERROR_IT_MASK))
  {
    enablestatus = (unsigned int)((I2C_CR1_ERRIE) & (I2Cx->CR1));
  }
  /* If TC interrupt */
  else if ((unsigned int)(I2C_IT & TC_IT_MASK))
  {
    enablestatus = (unsigned int)((I2C_CR1_TCIE) & (I2Cx->CR1));
  }
  else
  {
    enablestatus = (unsigned int)((I2C_IT) & (I2Cx->CR1));
  }
