...
//#define SMCR_ETR_MASK               ((unsigned short)0x00FF)
//#define CCMR_OFFSET                 ((unsigned short)0x0018)
//#define CCER_CCE_SET                ((unsigned short)0x0001)
//#define CCER_CCNE_SET               ((unsigned short)0x0004)
  
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
/* Private function prototypes -----------------------------------------------*/

/*static void TI1_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter);
static void TI2_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter);
static void TI3_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter);
static void TI4_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter);*/
/* Private functions ---------------------------------------------------------*/
...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  if((TIMx == TIM1) || (TIMx == TIM2) || (TIMx == TIM3))
  {
    ...
    tmpcr1 &= (unsigned short)(~((unsigned short)(TIM_CR1_DIR | TIM_CR1_CMS)));
    tmpcr1 |= (unsigned int)TIM_TimeBaseInitStruct->TIM_CounterMode;
  }
 
  if(TIMx != TIM6)
  {
    /* Set the clock division */
    tmpcr1 &= (unsigned short)(~((unsigned short)TIM_CR1_CKD));
    tmpcr1 |= (unsigned int)TIM_TimeBaseInitStruct->TIM_ClockDivision;
  }
...
/*void TIM_UpdateDisableConfig(TIM_TypeDef* TIMx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    TIMx->CR1 &= (unsigned short)~((unsigned short)TIM_CR1_UDIS);
  }
}*/
...
/*void TIM_UpdateRequestConfig(TIM_TypeDef* TIMx, unsigned short TIM_UpdateSource)
{
  ...
  {
    // Reset the URS Bit
    TIMx->CR1 &= (unsigned short)~((unsigned short)TIM_CR1_URS);
  }
}*/
...
/*void TIM_SelectOnePulseMode(TIM_TypeDef* TIMx, unsigned short TIM_OPMode)
{
  ...
  // Reset the OPM Bit
  TIMx->CR1 &= (unsigned short)~((unsigned short)TIM_CR1_OPM);
...
/*void TIM_SetClockDivision(TIM_TypeDef* TIMx, unsigned short TIM_CKD)
{
  ...
  // Reset the CKD Bits
  TIMx->CR1 &= (unsigned short)~((unsigned short)TIM_CR1_CKD);
  // Set the CKD value
  TIMx->CR1 |= TIM_CKD;
}*/
...
/*void TIM_BDTRConfig(TIM_TypeDef* TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
  ...
  TIMx->BDTR = (unsigned int)TIM_BDTRInitStruct->TIM_OSSRState | TIM_BDTRInitStruct->TIM_OSSIState |
...
/*void TIM_CtrlPWMOutputs(TIM_TypeDef* TIMx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    TIMx->BDTR &= (unsigned short)(~((unsigned short)TIM_BDTR_MOE));
  }  
}*/
...
{
  unsigned short tmpccmrx = 0, tmpccer = 0, tmpcr2 = 0;
  ...
  TIMx->CCER &= (unsigned short)(~(unsigned short)TIM_CCER_CC1E);
  ...
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR1_OC1M));
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR1_CC1S));

  // Select the Output Compare Mode
  tmpccmrx |= TIM_OCInitStruct->TIM_OCMode;
  
  // Reset the Output Polarity level
  tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC1P));
  ...
  if((TIMx == TIM1) || (TIMx == TIM15) || (TIMx == TIM16) || (TIMx == TIM17))
  {
    ...
    tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC1NP));
    // Set the Output N Polarity
    tmpccer |= TIM_OCInitStruct->TIM_OCNPolarity;
    
    // Reset the Output N State
    tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC1NE));
    // Set the Output N State
    tmpccer |= TIM_OCInitStruct->TIM_OutputNState;
    
    // Reset the Ouput Compare and Output Compare N IDLE State
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS1));
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS1N));
...
/*void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  TIMx->CCER &= (unsigned short)(~((unsigned short)TIM_CCER_CC2E));
  ...
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR1_OC2M));
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR1_CC2S));
  
  // Select the Output Compare Mode
  tmpccmrx |= (unsigned short)(TIM_OCInitStruct->TIM_OCMode << 8);
  
  // Reset the Output Polarity level
  tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC2P));
  // Set the Output Compare Polarity
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OCPolarity << 4);
  
  // Set the Output State
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OutputState << 4);
  ...
  if((TIMx == TIM1) || (TIMx == TIM15))
  {
    ...
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS2));
    
    // Set the Output Idle state
    tmpcr2 |= (unsigned short)(TIM_OCInitStruct->TIM_OCIdleState << 2);
    ...
    {    
      ...
      // Reset the Output N Polarity level
      tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC2NP));
      // Set the Output N Polarity
      tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OCNPolarity << 4);
      
      // Reset the Output N State
      tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC2NE));
      // Set the Output N State
      tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OutputNState << 4);
      
      // Reset the Output Compare N IDLE State
      tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS2N));
      
      // Set the Output N Idle state
      tmpcr2 |= (unsigned short)(TIM_OCInitStruct->TIM_OCNIdleState << 2);
    }
  }
  // Write to TIMx CR2
  TIMx->CR2 = tmpcr2;
...
/*void TIM_OC3Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
  // Disable the Channel 2: Reset the CC2E Bit
  TIMx->CCER &= (unsigned short)(~((unsigned short)TIM_CCER_CC3E));
  ...
  // Reset the Output Compare mode and Capture/Compare selection Bits
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR2_OC3M));
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR2_CC3S));
  // Select the Output Compare Mode
  tmpccmrx |= TIM_OCInitStruct->TIM_OCMode;
  
  // Reset the Output Polarity level
  tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC3P));
  // Set the Output Compare Polarity
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OCPolarity << 8);
  
  // Set the Output State
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OutputState << 8);
  ...
  if(TIMx == TIM1)
  {
    ...
    // Reset the Output N Polarity level
    tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC3NP));
    // Set the Output N Polarity
    tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OCNPolarity << 8);
    // Reset the Output N State
    tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC3NE));
    
    // Set the Output N State
    tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OutputNState << 8);
    // Reset the Ouput Compare and Output Compare N IDLE State
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS3));
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS3N));
    // Set the Output Idle state
    tmpcr2 |= (unsigned short)(TIM_OCInitStruct->TIM_OCIdleState << 4);
    // Set the Output N Idle state
    tmpcr2 |= (unsigned short)(TIM_OCInitStruct->TIM_OCNIdleState << 4);
  }
  // Write to TIMx CR2
  TIMx->CR2 = tmpcr2;
...
/*void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  TIMx->CCER &= (unsigned short)(~((unsigned short)TIM_CCER_CC4E));
  ...
  // Reset the Output Compare mode and Capture/Compare selection Bits
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR2_OC4M));
  tmpccmrx &= (unsigned short)(~((unsigned short)TIM_CCMR2_CC4S));
  
  // Select the Output Compare Mode
  tmpccmrx |= (unsigned short)(TIM_OCInitStruct->TIM_OCMode << 8);
  
  // Reset the Output Polarity level
  tmpccer &= (unsigned short)(~((unsigned short)TIM_CCER_CC4P));
  // Set the Output Compare Polarity
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OCPolarity << 12);
  
  // Set the Output State
  tmpccer |= (unsigned short)(TIM_OCInitStruct->TIM_OutputState << 12);
    
  if(TIMx == TIM1)
  {
    assert_param(IS_TIM_OCIDLE_STATE(TIM_OCInitStruct->TIM_OCIdleState));
    // Reset the Ouput Compare IDLE State
    tmpcr2 &= (unsigned short)(~((unsigned short)TIM_CR2_OIS4));
    // Set the Output Idle state
    tmpcr2 |= (unsigned short)(TIM_OCInitStruct->TIM_OCIdleState << 6);
  }
  // Write to TIMx CR2
  TIMx->CR2 = tmpcr2;
...
/*void TIM_SelectOCxM(TIM_TypeDef* TIMx, unsigned short TIM_Channel, unsigned short TIM_OCMode)
{
  ...
  tmp = (unsigned int) TIMx;
  tmp += CCMR_OFFSET;

  tmp1 = CCER_CCE_SET << (unsigned short)TIM_Channel;

  // Disable the Channel: Reset the CCxE Bit
  TIMx->CCER &= (unsigned short) ~tmp1;
  ...
  if((TIM_Channel == TIM_Channel_1) ||(TIM_Channel == TIM_Channel_3))
  {
    ...
    *(__IO unsigned int *) tmp &= (unsigned int)~((unsigned int)TIM_CCMR1_OC1M);
   
    // Configure the OCxM bits in the CCMRx register
    *(__IO unsigned int *) tmp |= TIM_OCMode;
  }
  else
  {
    tmp += (unsigned short)(TIM_Channel - (unsigned short)4)>> (unsigned short)1;

    // Reset the OCxM bits in the CCMRx register
    *(__IO unsigned int *) tmp &= (unsigned int)~((unsigned int)TIM_CCMR1_OC2M);
    
    // Configure the OCxM bits in the CCMRx register
    *(__IO unsigned int *) tmp |= (unsigned short)(TIM_OCMode << 8);
  }
}*/
...
{
  unsigned short tmpccmr1 = 0;
  // Check the parameters
  assert_param(IS_TIM_LIST4_PERIPH(TIMx));
  assert_param(IS_TIM_FORCED_ACTION(TIM_ForcedAction));
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC1M Bits
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC1M);
...
/*void TIM_ForcedOC2Config(TIM_TypeDef* TIMx, unsigned short TIM_ForcedAction)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC2M Bits
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC2M);
  // Configure The Forced output Mode
  tmpccmr1 |= (unsigned short)(TIM_ForcedAction << 8);
  // Write to TIMx CCMR1 register
  TIMx->CCMR1 = tmpccmr1;
}*/
...
/*void TIM_ForcedOC3Config(TIM_TypeDef* TIMx, unsigned short TIM_ForcedAction)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC1M Bits
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC3M);
  // Configure The Forced output Mode
...
/*void TIM_ForcedOC4Config(TIM_TypeDef* TIMx, unsigned short TIM_ForcedAction)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC2M Bits
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC4M);
  // Configure The Forced output Mode
  tmpccmr2 |= (unsigned short)(TIM_ForcedAction << 8);
  // Write to TIMx CCMR2 register
  TIMx->CCMR2 = tmpccmr2;
}*/
...
{ 
  ...
  {
    // Reset the CCPC Bit
    TIMx->CR2 &= (unsigned short)~((unsigned short)TIM_CR2_CCPC);
  }
}*/
...
/*void TIM_OC1FastConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCFast)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC1FE Bit
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC1FE);
...
/*void TIM_OC2FastConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCFast)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC2FE Bit
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC2FE);
  // Enable or Disable the Output Compare Fast Bit
  tmpccmr1 |= (unsigned short)(TIM_OCFast << 8);
  // Write to TIMx CCMR1
  TIMx->CCMR1 = tmpccmr1;
}*/
...
/*void TIM_OC3FastConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCFast)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC3FE Bit
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC3FE);
  // Enable or Disable the Output Compare Fast Bit
  tmpccmr2 |= TIM_OCFast;
  // Write to TIMx CCMR2
  TIMx->CCMR2 = tmpccmr2;
...
/*void TIM_OC4FastConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCFast)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC4FE Bit
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC4FE);
  // Enable or Disable the Output Compare Fast Bit
  tmpccmr2 |= (unsigned short)(TIM_OCFast << 8);
  // Write to TIMx CCMR2
  TIMx->CCMR2 = tmpccmr2;
}*/
...
/*void TIM_ClearOC1Ref(TIM_TypeDef* TIMx, unsigned short TIM_OCClear)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC1CE Bit
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC1CE);
...
/*void TIM_ClearOC2Ref(TIM_TypeDef* TIMx, unsigned short TIM_OCClear)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  // Reset the OC2CE Bit
  tmpccmr1 &= (unsigned short)~((unsigned short)TIM_CCMR1_OC2CE);
  // Enable or Disable the Output Compare Clear Bit
  tmpccmr1 |= (unsigned short)(TIM_OCClear << 8);
  // Write to TIMx CCMR1 register
  TIMx->CCMR1 = tmpccmr1;
}*/
...
/*void TIM_ClearOC3Ref(TIM_TypeDef* TIMx, unsigned short TIM_OCClear)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC3CE Bit
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC3CE);
  // Enable or Disable the Output Compare Clear Bit
...
/*void TIM_ClearOC4Ref(TIM_TypeDef* TIMx, unsigned short TIM_OCClear)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  // Reset the OC4CE Bit
  tmpccmr2 &= (unsigned short)~((unsigned short)TIM_CCMR2_OC4CE);
  // Enable or Disable the Output Compare Clear Bit
  tmpccmr2 |= (unsigned short)(TIM_OCClear << 8);
  // Write to TIMx CCMR2 register
  TIMx->CCMR2 = tmpccmr2;
}*/
...
/*void TIM_OC2PolarityConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCPolarity)
{
  ...
  tmpccer &= (unsigned short)~((unsigned short)TIM_CCER_CC2P);
  tmpccer |= (unsigned short)(TIM_OCPolarity << 4);
  // Write to TIMx CCER register
  TIMx->CCER = tmpccer;
}*/
...
/*void TIM_OC2NPolarityConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCNPolarity)
{
  ...
  tmpccer &= (unsigned short)~((unsigned short)TIM_CCER_CC2NP);
  tmpccer |= (unsigned short)(TIM_OCNPolarity << 4);
  // Write to TIMx CCER register
  TIMx->CCER = tmpccer;
}*/
...
/*void TIM_OC3PolarityConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCPolarity)
{
  ...
  tmpccer &= (unsigned short)~((unsigned short)TIM_CCER_CC3P);
  tmpccer |= (unsigned short)(TIM_OCPolarity << 8);
  // Write to TIMx CCER register
  TIMx->CCER = tmpccer;
}*/
...
/*void TIM_OC3NPolarityConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCNPolarity)
{
  ...
  tmpccer &= (unsigned short)~((unsigned short)TIM_CCER_CC3NP);
  tmpccer |= (unsigned short)(TIM_OCNPolarity << 8);
  // Write to TIMx CCER register
  TIMx->CCER = tmpccer;
}*/
...
/*void TIM_OC4PolarityConfig(TIM_TypeDef* TIMx, unsigned short TIM_OCPolarity)
{
  ...
  tmpccer &= (unsigned short)~((unsigned short)TIM_CCER_CC4P);
  tmpccer |= (unsigned short)(TIM_OCPolarity << 12);
  // Write to TIMx CCER register
  TIMx->CCER = tmpccer;
}*/
...
/*void TIM_SelectOCREFClear(TIM_TypeDef* TIMx, unsigned short TIM_OCReferenceClear)
{
  ...
  TIMx->SMCR &=  (unsigned short)~((unsigned short)TIM_SMCR_OCCS);
...
/*void TIM_CCxCmd(TIM_TypeDef* TIMx, unsigned short TIM_Channel, unsigned short TIM_CCx)
{
  ...
  // Reset the CCxE Bit
  TIMx->CCER &= (unsigned short)~ tmp;

  // Set or reset the CCxE Bit
  TIMx->CCER |=  (unsigned short)(TIM_CCx << TIM_Channel);
}*/
...
/*void TIM_CCxNCmd(TIM_TypeDef* TIMx, unsigned short TIM_Channel, unsigned short TIM_CCxN)
{
  ...
  TIMx->CCER |=  (unsigned short)(TIM_CCxN << TIM_Channel);
}*/
...
/*void TIM_SelectCOM(TIM_TypeDef* TIMx, FunctionalState NewState)
{
  ...
  {
    // Reset the COM Bit
    TIMx->CR2 &= (unsigned short)~((unsigned short)TIM_CR2_CCUS);
  }
}*/
...
{
  unsigned short icoppositepolarity = TIM_ICPolarity_Rising;
  unsigned short icoppositeselection = TIM_ICSelection_DirectTI;
  // Check the parameters
  assert_param(IS_TIM_LIST6_PERIPH(TIMx));
...
/*void TIM_SetIC1Prescaler(TIM_TypeDef* TIMx, unsigned short TIM_ICPSC)
{
  ...
  TIMx->CCMR1 &= (unsigned short)~((unsigned short)TIM_CCMR1_IC1PSC);
...
/*void TIM_SetIC2Prescaler(TIM_TypeDef* TIMx, unsigned short TIM_ICPSC)
{
  ...
  TIMx->CCMR1 &= (unsigned short)~((unsigned short)TIM_CCMR1_IC2PSC);
  // Set the IC2PSC value
  TIMx->CCMR1 |= (unsigned short)(TIM_ICPSC << 8);
}*/
...
/*void TIM_SetIC3Prescaler(TIM_TypeDef* TIMx, unsigned short TIM_ICPSC)
{
  ...
  TIMx->CCMR2 &= (unsigned short)~((unsigned short)TIM_CCMR2_IC3PSC);
...
{  
  ...
  TIMx->CCMR2 &= (unsigned short)~((unsigned short)TIM_CCMR2_IC4PSC);
  // Set the IC4PSC value
  TIMx->CCMR2 |= (unsigned short)(TIM_ICPSC << 8);
}*/
...
{ 
  ...
  if ((TIMx->SR & TIM_FLAG) != (unsigned short)RESET)
  {
    bitstatus = SET;
  }
  else
...
{  
  ...
  // Clear the flags
  TIMx->SR = (unsigned short)~TIM_FLAG;
}*/
...
{
  ITStatus bitstatus = RESET;  
  unsigned short itstatus = 0x0, itenable = 0x0;
...
{ 
  ...
  else
  {
    ...
    TIMx->DIER &= (unsigned short)~TIM_DMASource;
  }
}*/
...
/*void TIM_SelectCCDMA(TIM_TypeDef* TIMx, FunctionalState NewState)
{
  ...
  {
    // Reset the CCDS Bit
    TIMx->CR2 &= (unsigned short)~((unsigned short)TIM_CR2_CCDS);
  }
}*/
...
/*void TIM_InternalClockConfig(TIM_TypeDef* TIMx)
{
  ...
  TIMx->SMCR &=  (unsigned short)(~((unsigned short)TIM_SMCR_SMS));
}*/
                             ...
                             unsigned short ExtTRGFilter)
{
  ...
  tmpsmcr = TIMx->SMCR;
  // Reset the SMS Bits
  tmpsmcr &= (unsigned short)(~((unsigned short)TIM_SMCR_SMS));
  // Select the External clock mode1
  tmpsmcr |= TIM_SlaveMode_External1;
  // Select the Trigger selection : ETRF
  tmpsmcr &= (unsigned short)(~((unsigned short)TIM_SMCR_TS));
  tmpsmcr |= TIM_TS_ETRF;
  // Write to TIMx SMCR
  TIMx->SMCR = tmpsmcr;
}*/
 ...
 ===============================================================================
    ...
    [..] Case of Timers and external trigger(ETR pin)
         (#) Configure the Etrenal trigger using this function:
             (++) void TIM_ETRConfig(TIM_TypeDef* TIMx, unsigned short TIM_ExtTRGPrescaler,
                  unsigned short TIM_ExtTRGPolarity, unsigned short ExtTRGFilter);
         (#) Configure the Slave Timers using the following functions:
             (++) void TIM_SelectInputTrigger(TIM_TypeDef* TIMx,
                  unsigned short TIM_InputTriggerSource);
...
/*void TIM_SelectOutputTrigger(TIM_TypeDef* TIMx, unsigned short TIM_TRGOSource)
{
  ...
  // Reset the MMS Bits
  TIMx->CR2 &= (unsigned short)~((unsigned short)TIM_CR2_MMS);
...
/*void TIM_SelectMasterSlaveMode(TIM_TypeDef* TIMx, unsigned short TIM_MasterSlaveMode)
{
  ...
  // Reset the MSM Bit
  TIMx->SMCR &= (unsigned short)~((unsigned short)TIM_SMCR_MSM);
                   ...
                   unsigned short ExtTRGFilter)
{
  ...
  tmpsmcr |= (unsigned short)(TIM_ExtTRGPrescaler | (unsigned short)(TIM_ExtTRGPolarity | (unsigned short)(ExtTRGFilter << (unsigned short)8)));
  // Write to TIMx SMCR
  TIMx->SMCR = tmpsmcr;
}*/
                                ...
                                unsigned short TIM_IC1Polarity, unsigned short TIM_IC2Polarity)
{
  ...
  tmpccmr1 &= (unsigned short)(((unsigned short)~((unsigned short)TIM_CCMR1_CC1S)) & (unsigned short)(~((unsigned short)TIM_CCMR1_CC2S)));
  tmpccmr1 |= TIM_CCMR1_CC1S_0 | TIM_CCMR1_CC2S_0;
  // Set the TI1 and the TI2 Polarities
  tmpccer &= (unsigned short)~((unsigned short)(TIM_CCER_CC1P | TIM_CCER_CC1NP)) & (unsigned short)~((unsigned short)(TIM_CCER_CC2P | TIM_CCER_CC2NP));
  tmpccer |= (unsigned short)(TIM_IC1Polarity | (unsigned short)(TIM_IC2Polarity << (unsigned short)4));
  // Write to TIMx SMCR
  TIMx->SMCR = tmpsmcr;
  // Write to TIMx CCMR1
  TIMx->CCMR1 = tmpccmr1;
...
/*void TIM_SelectHallSensor(TIM_TypeDef* TIMx, FunctionalState NewState)
{
  ...
  {
    // Reset the TI1S Bit
    TIMx->CR2 &= (unsigned short)~((unsigned short)TIM_CR2_TI1S);
  }
}*/
...
/*static void TI1_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter)
{
  unsigned short tmpccmr1 = 0, tmpccer = 0;
  // Disable the Channel 1: Reset the CC1E Bit
  TIMx->CCER &= (unsigned short)~((unsigned short)TIM_CCER_CC1E);
  tmpccmr1 = TIMx->CCMR1;
  tmpccer = TIMx->CCER;
  // Select the Input and set the filter
  tmpccmr1 &= (unsigned short)(((unsigned short)~((unsigned short)TIM_CCMR1_CC1S)) & ((unsigned short)~((unsigned short)TIM_CCMR1_IC1F)));
  tmpccmr1 |= (unsigned short)(TIM_ICSelection | (unsigned short)(TIM_ICFilter << (unsigned short)4));
 
  // Select the Polarity and set the CC1E Bit
  tmpccer &= (unsigned short)~((unsigned short)(TIM_CCER_CC1P | TIM_CCER_CC1NP));
  tmpccer |= (unsigned short)(TIM_ICPolarity | (unsigned short)TIM_CCER_CC1E);
...
/*static void TI2_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter)
{
  unsigned short tmpccmr1 = 0, tmpccer = 0, tmp = 0;
  // Disable the Channel 2: Reset the CC2E Bit
  TIMx->CCER &= (unsigned short)~((unsigned short)TIM_CCER_CC2E);
  tmpccmr1 = TIMx->CCMR1;
  tmpccer = TIMx->CCER;
  tmp = (unsigned short)(TIM_ICPolarity << 4);
  // Select the Input and set the filter
  tmpccmr1 &= (unsigned short)(((unsigned short)~((unsigned short)TIM_CCMR1_CC2S)) & ((unsigned short)~((unsigned short)TIM_CCMR1_IC2F)));
  tmpccmr1 |= (unsigned short)(TIM_ICFilter << 12);
  tmpccmr1 |= (unsigned short)(TIM_ICSelection << 8);
  // Select the Polarity and set the CC2E Bit
  tmpccer &= (unsigned short)~((unsigned short)(TIM_CCER_CC2P | TIM_CCER_CC2NP));
  tmpccer |= (unsigned short)(tmp | (unsigned short)TIM_CCER_CC2E);
  // Write to TIMx CCMR1 and CCER registers
  TIMx->CCMR1 = tmpccmr1 ;
  TIMx->CCER = tmpccer;
}*/
...
/*static void TI3_Config(TIM_TypeDef* TIMx, unsigned short TIM_ICPolarity, unsigned short TIM_ICSelection,
                       unsigned short TIM_ICFilter)
{
  unsigned short tmpccmr2 = 0, tmpccer = 0, tmp = 0;
  // Disable the Channel 3: Reset the CC3E Bit
  TIMx->CCER &= (unsigned short)~((unsigned short)TIM_CCER_CC3E);
  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (unsigned short)(TIM_ICPolarity << 8);
  // Select the Input and set the filter
  tmpccmr2 &= (unsigned short)(((unsigned short)~((unsigned short)TIM_CCMR2_CC3S)) & ((unsigned short)~((unsigned short)TIM_CCMR2_IC3F)));
  tmpccmr2 |= (unsigned short)(TIM_ICSelection | (unsigned short)(TIM_ICFilter << (unsigned short)4));
  // Select the Polarity and set the CC3E Bit
  tmpccer &= (unsigned short)~((unsigned short)(TIM_CCER_CC3P | TIM_CCER_CC3NP));
  tmpccer |= (unsigned short)(tmp | (unsigned short)TIM_CCER_CC3E);
                       ...
                       unsigned short TIM_ICFilter)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (unsigned short)(TIM_ICPolarity << 12);
  // Select the Input and set the filter
  tmpccmr2 &= (unsigned short)((unsigned short)(~(unsigned short)TIM_CCMR2_CC4S) & ((unsigned short)~((unsigned short)TIM_CCMR2_IC4F)));
  tmpccmr2 |= (unsigned short)(TIM_ICSelection << 8);
  tmpccmr2 |= (unsigned short)(TIM_ICFilter << 12);
  // Select the Polarity and set the CC4E Bit
  tmpccer &= (unsigned short)~((unsigned short)(TIM_CCER_CC4P | TIM_CCER_CC4NP));
  tmpccer |= (unsigned short)(tmp | (unsigned short)TIM_CCER_CC4E);
  // Write to TIMx CCMR2 and CCER registers
  TIMx->CCMR2 = tmpccmr2;
  TIMx->CCER = tmpccer;
}*/
