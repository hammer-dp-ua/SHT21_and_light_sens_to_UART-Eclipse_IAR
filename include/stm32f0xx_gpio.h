...
#define IS_GPIO_PIN(PIN) ((PIN) != (unsigned short)0x00)
...
/** 
  ...
  */
#define GPIO_AF_0            ((unsigned char)0x00) /* WKUP, EVENTOUT, TIM15, SPI1, TIM17,
...
/** 
  ...
  */
#define GPIO_AF_1            ((unsigned char)0x01) /* USART2, CEC, TIM3, USART1, IR,
                                                EVENTOUT, I2C1, I2C2, TIM15, SPI2,
                                                USART3, TS, SPI1 */
/** 
  * @brief  AF 2 selection
  */
#define GPIO_AF_2            ((unsigned char)0x02) /* TIM2, TIM1, EVENTOUT, TIM16, TIM17,
                                                USB */
/** 
  * @brief  AF 3 selection
  */
#define GPIO_AF_3            ((unsigned char)0x03) /* TS, I2C1, TIM15, EVENTOUT */

/** 
  * @brief  AF 4 selection
  */
#define GPIO_AF_4            ((unsigned char)0x04) /* TIM14, USART4, USART3, CRS, CAN,
                                                I2C1 */

/** 
  * @brief  AF 5 selection
  */
#define GPIO_AF_5            ((unsigned char)0x05) /* TIM16, TIM17, TIM15, SPI2, I2C2,
                                                MCO, I2C1, USB */

/** 
  * @brief  AF 6 selection
  */
#define GPIO_AF_6            ((unsigned char)0x06) /* EVENTOUT */
/** 
  * @brief  AF 7 selection
  */
#define GPIO_AF_7            ((unsigned char)0x07) /* COMP1 OUT and COMP2 OUT */
...
void GPIO_PinLockConfig(GPIO_TypeDef* GPIOx, unsigned short GPIO_Pin);

/* GPIO Read and Write functions **********************************************/
unsigned char GPIO_ReadInputDataBit(GPIO_TypeDef* GPIOx, unsigned short GPIO_Pin);
unsigned short GPIO_ReadInputData(GPIO_TypeDef* GPIOx);
unsigned char GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, unsigned short GPIO_Pin);
unsigned short GPIO_ReadOutputData(GPIO_TypeDef* GPIOx);
...
void GPIO_Write(GPIO_TypeDef* GPIOx, unsigned short PortVal);
