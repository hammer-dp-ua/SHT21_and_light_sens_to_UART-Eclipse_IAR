...
typedef struct
{
  ...
  unsigned int PCLK_Frequency;
  unsigned int ADCCLK_Frequency;
  unsigned int CECCLK_Frequency;
  unsigned int I2C1CLK_Frequency;
  unsigned int USART1CLK_Frequency;
  unsigned int USART2CLK_Frequency; /*!< Only applicable for STM32F072 and STM32F091 devices */
  unsigned int USART3CLK_Frequency; /*!< Only applicable for STM32F091 devices */
  unsigned int USBCLK_Frequency;    /*!< Only applicable for STM32F072 devices */
}RCC_ClocksTypeDef;
...
#define RCC_HSE_OFF                      ((unsigned char)0x00)
#define RCC_HSE_ON                       ((unsigned char)0x01)
#define RCC_HSE_Bypass                   ((unsigned char)0x05)
...
#define RCC_ADCCLK_HSI14                 ((unsigned int)0x00000000)
#define RCC_ADCCLK_PCLK_Div2             ((unsigned int)0x01000000)
#define RCC_ADCCLK_PCLK_Div4             ((unsigned int)0x01004000)
...
#define RCC_CECCLK_HSI_Div244            ((unsigned int)0x00000000)
...
#define RCC_I2C1CLK_HSI                   ((unsigned int)0x00000000)
...
#define RCC_USBCLK_HSI48                 ((unsigned int)0x00000000)
...
#define RCC_USART1CLK_PCLK                  ((unsigned int)0x10000000)
#define RCC_USART1CLK_SYSCLK                ((unsigned int)0x10000001)
#define RCC_USART1CLK_LSE                   ((unsigned int)0x10000002)
#define RCC_USART1CLK_HSI                   ((unsigned int)0x10000003)

#define RCC_USART2CLK_PCLK                  ((unsigned int)0x20000000) /*!< Only applicable for STM32F072 and STM32F091 devices */
#define RCC_USART2CLK_SYSCLK                ((unsigned int)0x20010000) /*!< Only applicable for STM32F072 and STM32F091 devices */
#define RCC_USART2CLK_LSE                   ((unsigned int)0x20020000) /*!< Only applicable for STM32F072 and STM32F091 devices */
#define RCC_USART2CLK_HSI                   ((unsigned int)0x20030000) /*!< Only applicable for STM32F072 and STM32F091 devices */

#define RCC_USART3CLK_PCLK                  ((unsigned int)0x30000000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_SYSCLK                ((unsigned int)0x30040000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_LSE                   ((unsigned int)0x30080000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_HSI                   ((unsigned int)0x300C0000) /*!< Only applicable for STM32F091 devices */
...
#define RCC_IT_LSIRDY                    ((unsigned char)0x01)
#define RCC_IT_LSERDY                    ((unsigned char)0x02)
#define RCC_IT_HSIRDY                    ((unsigned char)0x04)
#define RCC_IT_HSERDY                    ((unsigned char)0x08)
#define RCC_IT_PLLRDY                    ((unsigned char)0x10)
#define RCC_IT_HSI14RDY                  ((unsigned char)0x20)
#define RCC_IT_HSI48RDY                  ((unsigned char)0x40) /*!< Only applicable for STM32F072 devices */
#define RCC_IT_CSS                       ((unsigned char)0x80)

#define IS_RCC_IT(IT) ((((IT) & (unsigned char)0x80) == 0x00) && ((IT) != 0x00))
...
#define RCC_LSE_OFF                      ((unsigned int)0x00000000)
#define RCC_LSE_ON                       RCC_BDCR_LSEON
#define RCC_LSE_Bypass                   ((unsigned int)(RCC_BDCR_LSEON | RCC_BDCR_LSEBYP))
...
#define RCC_LSEDrive_Low                 ((unsigned int)0x00000000)
...
#define RCC_MCOSource_NoClock            ((unsigned char)0x00)
#define RCC_MCOSource_HSI14              ((unsigned char)0x01)
#define RCC_MCOSource_LSI                ((unsigned char)0x02)
#define RCC_MCOSource_LSE                ((unsigned char)0x03)
#define RCC_MCOSource_SYSCLK             ((unsigned char)0x04)
#define RCC_MCOSource_HSI                ((unsigned char)0x05)
#define RCC_MCOSource_HSE                ((unsigned char)0x06)
#define RCC_MCOSource_PLLCLK_Div2        ((unsigned char)0x07)
#define RCC_MCOSource_HSI48              ((unsigned char)0x08)  /*!< Only applicable for STM32F072 devices */
#define RCC_MCOSource_PLLCLK             ((unsigned char)0x87)
...
/** @defgroup RCC_Flag 
  * @{
  */
#define RCC_FLAG_HSIRDY                  ((unsigned char)0x01)
#define RCC_FLAG_HSERDY                  ((unsigned char)0x11)
#define RCC_FLAG_PLLRDY                  ((unsigned char)0x19)
#define RCC_FLAG_LSERDY                  ((unsigned char)0x21)
#define RCC_FLAG_LSIRDY                  ((unsigned char)0x41)
#define RCC_FLAG_V18PWRRSTF              ((unsigned char)0x57)
#define RCC_FLAG_OBLRST                  ((unsigned char)0x59)
#define RCC_FLAG_PINRST                  ((unsigned char)0x5A)
#define RCC_FLAG_PORRST                  ((unsigned char)0x5B)
#define RCC_FLAG_SFTRST                  ((unsigned char)0x5C)
#define RCC_FLAG_IWDGRST                 ((unsigned char)0x5D)
#define RCC_FLAG_WWDGRST                 ((unsigned char)0x5E)
#define RCC_FLAG_LPWRRST                 ((unsigned char)0x5F)
#define RCC_FLAG_HSI14RDY                ((unsigned char)0x61)
#define RCC_FLAG_HSI48RDY                ((unsigned char)0x71) /*!< Only applicable for STM32F072 devices */
...
void RCC_HSEConfig(unsigned char RCC_HSE);
ErrorStatus RCC_WaitForHSEStartUp(void);
void RCC_AdjustHSICalibrationValue(unsigned char HSICalibrationValue);
void RCC_HSICmd(FunctionalState NewState);
void RCC_AdjustHSI14CalibrationValue(unsigned char HSI14CalibrationValue);
void RCC_HSI14Cmd(FunctionalState NewState);
void RCC_HSI14ADCRequestCmd(FunctionalState NewState);
void RCC_LSEConfig(unsigned int RCC_LSE);
void RCC_LSEDriveConfig(unsigned int RCC_LSEDrive);
void RCC_LSICmd(FunctionalState NewState);
void RCC_PLLConfig(unsigned int RCC_PLLSource, unsigned int RCC_PLLMul);
void RCC_PLLCmd(FunctionalState NewState);
void RCC_HSI48Cmd(FunctionalState NewState); /*!< Only applicable for STM32F072 devices */
unsigned int RCC_GetHSI48CalibrationValue(void); /*!< Only applicable for STM32F072 devices */
void RCC_PREDIV1Config(unsigned int RCC_PREDIV1_Div);
void RCC_ClockSecuritySystemCmd(FunctionalState NewState);
#ifdef STM32F051
void RCC_MCOConfig(unsigned char RCC_MCOSource);
#else
void RCC_MCOConfig(unsigned char RCC_MCOSource,unsigned int RCC_MCOPrescaler);
#endif /* STM32F051 */

/* System, AHB and APB busses clocks configuration functions ******************/
void RCC_SYSCLKConfig(unsigned int RCC_SYSCLKSource);
unsigned char RCC_GetSYSCLKSource(void);
void RCC_HCLKConfig(unsigned int RCC_SYSCLK);
void RCC_PCLKConfig(unsigned int RCC_HCLK);
void RCC_ADCCLKConfig(unsigned int RCC_ADCCLK); /* This function is obsolete.
                                               For proper ADC clock selection, refer to
                                               ADC_ClockModeConfig() in the ADC driver */
void RCC_CECCLKConfig(unsigned int RCC_CECCLK);
void RCC_I2CCLKConfig(unsigned int RCC_I2CCLK);
void RCC_USARTCLKConfig(unsigned int RCC_USARTCLK);
void RCC_USBCLKConfig(unsigned int RCC_USBCLK); /*!< Only applicable for STM32F042 and STM32F072 devices */
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks);

/* Peripheral clocks configuration functions **********************************/
void RCC_RTCCLKConfig(unsigned int RCC_RTCCLKSource);
void RCC_RTCCLKCmd(FunctionalState NewState);
void RCC_BackupResetCmd(FunctionalState NewState);

void RCC_AHBPeriphClockCmd(unsigned int RCC_AHBPeriph, FunctionalState NewState);
void RCC_APB2PeriphClockCmd(unsigned int RCC_APB2Periph, FunctionalState NewState);
void RCC_APB1PeriphClockCmd(unsigned int RCC_APB1Periph, FunctionalState NewState);

void RCC_AHBPeriphResetCmd(unsigned int RCC_AHBPeriph, FunctionalState NewState);
...
void RCC_ITConfig(unsigned char RCC_IT, FunctionalState NewState);
FlagStatus RCC_GetFlagStatus(unsigned char RCC_FLAG);
void RCC_ClearFlag(void);
ITStatus RCC_GetITStatus(unsigned char RCC_IT);
void RCC_ClearITPendingBit(unsigned char RCC_IT);
